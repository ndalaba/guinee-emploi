        ...
        <div class="row left">
            ...
            <div class="col-lg-12 filtre">
                <form id="frmfiltreOffre" class="form-horizontal">
                    ...
                    <?php elseif (isset($motcle)) : ?><!-- Page affichée à la suite d'une recherche par mot clé (utilisé dans le js) -->
                        <input type="hidden" id="action" value="<?php echo $motcle ?>" action="motcle" ville="<?php echo $motcle ?>"/>
                            ...
                            <div class="col-lg-12 ">
                                ...
                                <div class="row ">
                                    <div class="col-lg-9">
                                     ...
                                     <?php if (($recruteur->logo!= NULL) AND $recruteur->logo != ""): ?>
                                        <div class="col-lg-2">
            ...
            <div class="row">
                <div class="col-lg-11" style="text-align: right; ">
                    <p>
                        <button class="btn btn-xs btn-success pagin_last_offre">Voire les offres suivantes &raquo;&raquo;</button>
                    </p>
                </div>
            </div> 
